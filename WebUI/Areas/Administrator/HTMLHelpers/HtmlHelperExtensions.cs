...
namespace WebUI.Areas.Administrator.HtmlHelpers
{
    public static class HtmlHelperExtensions
    {
        public static MvcHtmlString AdminPager(this HtmlHelper helper, int currentPageIndex, Func<int, string> action, int totalItems, int pageSize = 10, int numberOfLinks = 5)
